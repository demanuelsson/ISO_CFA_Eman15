function [Time,H2Oc_ppm,O18_del,D_del,GasP_torr,GasT_C,AmbT_C] = ImportLGRall(filename, startRow, endRow)
...
Time = cell2mat(raw(:, 1));
%H2O16c_ppm = cell2mat(raw(:, 2));
%H2O16c_ppm_se = cell2mat(raw(:, 3));
%H2O18c_ppm = cell2mat(raw(:, 4));
%H2O18c_ppm_se = cell2mat(raw(:, 5));
%HODc_ppm = cell2mat(raw(:, 6));
%HODc_ppm_se = cell2mat(raw(:, 7));
H2Oc_ppm = cell2mat(raw(:, 8));
%H2Oc_ppm_se = cell2mat(raw(:, 9));
O18_del = cell2mat(raw(:, 10));
%O18_del_se = cell2mat(raw(:, 11));
D_del = cell2mat(raw(:, 12));
%D_del_se = cell2mat(raw(:, 13));
GasP_torr = cell2mat(raw(:, 14));
%GasP_torr_se = cell2mat(raw(:, 15));
GasT_C = cell2mat(raw(:, 16));
%GasT_C_se = cell2mat(raw(:, 17));
AmbT_C = cell2mat(raw(:, 18));
